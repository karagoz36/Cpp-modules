...
/*   Updated: 2024/10/29 18:09:53 by tkaragoz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat() : _name("Default"), _grade(150) {
	// std::cout << _name << " (" << _grade << ") created by default constructor" << std::endl;
...
Bureaucrat::Bureaucrat(const std::string& name, int grade) : _name(name), _grade(grade) {
	...
	// std::cout << _name << " (" << _grade << ") created by constructor" << std::endl;
